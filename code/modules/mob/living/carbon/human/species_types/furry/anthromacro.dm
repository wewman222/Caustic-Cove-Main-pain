/mob/living/carbon/human/species/anthromacro
	race = /datum/species/anthromacro
...
/datum/species/anthromacro/qualifies_for_rank(rank, list/features)
	return TRUE

/datum/species/anthromacro/get_random_features()
